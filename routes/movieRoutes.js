...
router.patch('/:id/favorite', toggleFavorite); // PATCH /api/movies/:id/favorite - Favorito
router.patch('/:id/rating', updateRating);     // PATCH /api/movies/:id/rating - Valoración
